        ...
        <div class="relative sm:max-w-sm w-full">
            ...
            <div class="relative w-full rounded-3xl  px-6 py-4 bg-gray-100 shadow-md">
                ...
                <form class="mt-10">
                    ...
                    <div class="mt-7">                
                        <input type="password" placeholder="Enter password" class="mt-1 block pl-3 w-full border-none bg-gray-100 h-11 rounded-xl shadow-lg hover:bg-blue-100 focus:bg-blue-100 focus:ring-0">                           
                    </div>
